...
export default function AppSettings() {
  ...
  useEffect(() => {
    ...
    setUnsaved(true);
  }, [appVersion, agoraAppId, agoraAppCertificate, appLogo, audioBg, audioSeat, multiBg, games, gravixApiKey, gravixApiSecret]);
...
setGravixApiSecret(record.get("GravixApiSecret") || "");
  ...
  const TABS = [
    ...
    { key: "gravix",  label: "Gravix",  icon: "🌐" },   // ← new
...
{tab === "gravix" && (
  <Section icon="🌐" title="GravixCloud Configuration" desc="Credentials for GravixCloud private streaming">
    <div className="as-fields">
      <Field label="API Key" hint="Your GravixCloud API key">
        <Input
          value={gravixApiKey}
          onChange={setGravixApiKey}
          placeholder="gck_..."
        />
      </Field>
